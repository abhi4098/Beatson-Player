 ...
 */
public class TopBandsAdapter extends RecyclerView.Adapter<TopBandsAdapter.ViewHolder>  {
    Context mContext;
    List<String> topBandsList;
    RecyclerViewOnClick recyclerViewOnClick;

    public TopBandsAdapter(Context mContext, List<String> topBandsList, RecyclerViewOnClick recyclerViewOnClick) {
        this.mContext = mContext;
        this.topBandsList = topBandsList;
